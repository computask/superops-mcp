...
assert.equal(createHash('sha256').update(code).digest('hex'),'5b71debcb7b2e57a34d0e257578bf16fecbc7fa560af3e839f563f466a455577','Reviewed production module must match the provenance record');
