...
assert.equal(createHash('sha256').update(code).digest('hex'),'a64f214bcd6d574bdf7d34364b0f3a57ea0c3be472487b9411203f3af5e531e0','Reviewed production module must match the provenance record');
