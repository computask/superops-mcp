...
assert.equal(createHash('sha256').update(code).digest('hex'),'237c62ad383a68539ca7a603058846262061caf51eb742f020d722f36a3648bc','Reviewed production module must match the provenance record');
