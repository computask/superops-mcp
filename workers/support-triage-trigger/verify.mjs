...
assert.equal(createHash('sha256').update(code).digest('hex'),'51b868cd9d0da013c4c61818c3257020eebe77a61a198f9fdd647f3e4a6cae26','Reviewed production module must match the provenance record');
