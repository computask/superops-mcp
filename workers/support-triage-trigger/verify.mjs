...
assert.equal(createHash('sha256').update(code).digest('hex'),'fc42cb06a15a6c7721023f43bde4f0b3d90b9b130100424c6536bcde39e696fb','Reviewed production module must match the provenance record');
