...
assert.equal(createHash('sha256').update(code).digest('hex'),'9a01ed54365302326c5300c2ccc5b6215d0c153a0c6359cf63187de0c99d2b1d','Reviewed production module must match the provenance record');
