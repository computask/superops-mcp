...
assert.equal(createHash('sha256').update(code).digest('hex'),'177a869603c6a8d5f980bc06b15436a4c672f6cf3823356e4526657873b0e3cd','Reviewed production module must match the provenance record');
