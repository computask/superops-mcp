...
assert.equal(createHash('sha256').update(code).digest('hex'),'c902b1914961653c3567e0695a5f0c3badffa916c753055e93f8f170db4a8f4b','Production baseline must not change without reconciliation');
