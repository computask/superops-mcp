...
assert.equal(createHash('sha256').update(code).digest('hex'),'29788ddfdd516b15a617ed47bf121f06f3ebc7a90d9cf378ffbd1ea80d87c58e','Reviewed production module must match the provenance record');
