...
assert.equal(createHash('sha256').update(code).digest('hex'),'7f884b20977f89c094174331ab64e4308ad045de83710b5a6a093cff334f8ed7','Reviewed production module must match the provenance record');
