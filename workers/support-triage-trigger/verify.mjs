...
assert.equal(createHash('sha256').update(code).digest('hex'),'5b31a4923dc5dead9b1936f58bba36f3f328e230682c26b7c41ad24909b1ef9f','Reviewed production module must match the provenance record');
